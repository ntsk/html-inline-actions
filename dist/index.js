...
async function main() {
    try {
        ...
        for (const filePath of expandedPaths) {
            ...
            const inlinedHtml = await (0, html_inline_1.inlineHtml)(filePath, {
                ignoreStyles,
                ignoreScripts,
                ignoreImages,
                ignoreLinks
            ...
            if (overwrite) {
                ...
                outputPath = (0, path_1.resolve)(dir, outputFileName);
            }
            await fs_1.promises.writeFile(outputPath, inlinedHtml, 'utf-8');
            if (overwrite) {
