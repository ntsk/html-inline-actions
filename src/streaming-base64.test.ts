...
import { Base64Transform, streamToBase64, createDataUrl } from './streaming-base64';
...
test('Base64Transform should handle small chunks correctly', async () => {
  ...
  strictEqual(result, expectedBase64);
...
test('Base64Transform should handle large files efficiently', async () => {
  ...
  strictEqual(streamResult, traditionalResult);
